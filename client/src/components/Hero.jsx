  ...
  return (
    <div className='container  2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
        <h2 className='text-2xl md:text-3xl lg:text-3xl font-medium mb-4'>Over10,000+ jobs to apply</h2>
        ...
        <div className='flex item-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx=4 sm:mx-auto'>
            <div className='flex items-center'>
                <img className='h4 sm:h5' src={assets.search_icon} alt="" />
                <input type="text" placeholder="Search for jobs" 
                className='max-sm:text-xs p-2 rounded outline-none w-full'
                ref={titleRef}/>
            </div>
            <div className='flex items-center'>
                <img className='h4 sm:h5' src={assets.location_icon} alt="" />
    ...
    <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
        <div className='flex justify-center gap-10 lg:gap-16 flex-wrap'>
            ...
            <img className='h-6' src={assets.amazon_logot_logo} alt="" />
