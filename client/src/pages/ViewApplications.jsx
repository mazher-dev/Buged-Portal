...
const ViewApplications = () => {
  return (
    <div className='container mx-auto p-4'>
      <div>
        <table className='w-full max-w-4xl bg-white boder-gray-200 max-sm:text-sm'>
          <thead>
          ...
          <tbody>
            {viewApplicationsPageData.map((applicant,index) =>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 bordder-b'>
                ...
                <td className='py-2 px-4 border-b relative'>
                  <div className='relative inline-block text-left group'>
                    ...
                    <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white boder border-gray-200 rounded shadow group-hover:block '>
                      ...
                      <button className='block w-full text-left px-4 py-2 text-red-600 hover:bg-gray-200'>Reject</button>
                    </div>
                  </div>
                </td>
              </tr>
